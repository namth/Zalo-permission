...
export default function AuditLogsPage() {
  ...
  const [filter, setFilter] = useState({ workspace_id: '', action: '' });
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Complete audit trail of all system actions</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2">
          <button
            onClick={() => setFilter({ workspace_id: '', action: '' })}
